...
class Arbusto(models.Model):
    nombreArbusto = models.CharField(primary_key=True,max_length=50,verbose_name='Nombre Arbusto')
...
class Flore(models.Model):
    nombreFlore = models.CharField(primary_key=True,max_length=50,verbose_name='Nombre Flores')
...
class Macetero(models.Model):
    nombreMacetero = models.CharField(primary_key=True,max_length=50,verbose_name='Nombre Arbusto')
    precio = models.CharField(max_length=6,verbose_name='Precio Arbusto')
    categoria = models.ForeignKey(Categoria,on_delete=models.CASCADE)
    upload = models.ImageField(upload_to ='A:\Repo\SOLEMNE-1\TestDjango\core\static\core\img\img_productos',verbose_name='Subir imagen')
...
class Tierra_De_Hoja(models.Model):
    nombreTierraDeHoja = models.CharField(primary_key=True,max_length=50,verbose_name='Nombre Arbusto')
    precio = models.CharField(max_length=6,verbose_name='Precio Arbusto')
    categoria = models.ForeignKey(Categoria,on_delete=models.CASCADE)
    upload = models.ImageField(upload_to ='A:\Repo\SOLEMNE-1\TestDjango\core\static\core\img\img_productos',verbose_name='Subir imagen')
